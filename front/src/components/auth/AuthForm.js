    ...
    const handleSubmit = async (e) => {
      ...
      try {
        if (type === 'signup') {
          ...
          // 회원가입 요청 보내기
          const response = await axios.post('http://i9b306.q.ssafy.io/api1/user/signup', {
            userName : name,
          ...
          try {
          // 로그인 요청 보내기
          const response = await axios.post('http://i9b306.q.ssafy.io/api1/user/login', {
            userEmail : email,
            userPassword : password,
          });
          ...
          try {
            // 회원정보 수정 요청 보내기
            const response = await axios.patch('http://i9b306.q.ssafy.io/api1/user/modify', {
              userName: name,
              userPassword: password,
              userProfile: null,
            }, {
